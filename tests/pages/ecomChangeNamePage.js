...
class EcomChangeNamePage {
    ...
    async verifyUserGetSuccessMessage(message) {
        await expect(this.sucess_Message).toBeVisible();
        await expect(this.sucess_Message).toContainText(new RegExp(message));
    }
}

export { EcomChangeNamePage };